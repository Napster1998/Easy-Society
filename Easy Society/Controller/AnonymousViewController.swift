...
class AnonymousViewController: UIViewController, UITextFieldDelegate,UITextViewDelegate {
    ...
    @IBAction func postButtonPressed(_ sender: UIButton) {
        ...
        complaintDB.childByAutoId().setValue(complaintDictionary) {
            ...
            if error != nil {
                ...
                print("Anonymous Complaint Recieved")
                
                SVProgressHUD.dismiss()
                
                self.myAlert(title: "Complaint Posted", message: "Complaint has been posted Anonymously")
